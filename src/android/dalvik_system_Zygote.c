/*
 * This program is taken as a reference, in which fork() is executed by zygote
 *
 * Especially pay attention to 
 * (1) forkAndSpecializeCommon,in which linux fork() is called to create new process
 * (2) Dalvik_dalvik_system_Zygote_forkAndSpecialize,in which forkAndSpecializeCommon
 *     is called.
 *
 *
